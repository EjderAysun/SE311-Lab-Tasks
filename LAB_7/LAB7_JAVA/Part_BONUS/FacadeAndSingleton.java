package LAB_7.LAB7_JAVA.Part_BONUS;

class FacadeAndSingleton {

    public static void main(String[] args) {
        EntertainmentRoom er = EntertainmentRoom.getEntertainmentRoom();
...
class EntertainmentRoom {
    ...
    private static EntertainmentRoom uniqueEntertainmentRoom;

    private EntertainmentRoom() {
        led = new TV();
        lg = new SoundBar();
        viewsonic = new StreamingDevice();
    }

    public static EntertainmentRoom getEntertainmentRoom() {
        if(uniqueEntertainmentRoom == null) uniqueEntertainmentRoom = new EntertainmentRoom();
        return uniqueEntertainmentRoom;
    }
